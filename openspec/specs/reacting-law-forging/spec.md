# reacting-law-forging Specification

## Purpose

Define the guarded adopter workflow that turns project-declared Rust architecture prose into a
reaction-proven Tianheng law candidate without inventing policy, overstating observation, or
